...
```bash
10_multistepWF_connectors$ sam build
```
...
```bash
10_multistepWF_connectors$ sam logs -n StockCheckerFunction --stack-name 10_multistepWF_connectors --tail
```
...
```bash
10_multistepWF_connectors$ cd functions/stock-checker
...
```bash
sam delete --stack-name 10_multistepWF_connectors
```
