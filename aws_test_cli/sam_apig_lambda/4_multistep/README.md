...
```bash
4_multistep$ sam logs -n StockCheckerFunction --stack-name 4_multistep --tail
```
...
```bash
4_multistep$ cd functions/stock-checker
...
```bash
sam delete --stack-name 4_multistep
```
